...
const Conheca_os_cortes = () => {
  return (
    <section
      className="bg-gray-50 rounded-lg px-6 py-16 sm:px-8 sm:py-20 md:px-16 md:py-28 lg:px-24 lg:py-32"
      aria-labelledby="titulo-cortes"
    >
      <header className="flex flex-col items-start md:items-center gap-12 max-w-6xl mx-auto">
        <h1
          id="titulo-cortes"
          className="text-4xl sm:text-5xl font-black font-titulo text-gray-900 text-start md:text-center"
        >
          Cortes especiais para pratos inesquecíveis.
        </h1>

        <p className="text-2xl sm:text-3xl md:text-2xl font-descricao text-gray-700 leading-relaxed text-start md:text-center">
      ...
      <div className="mt-32">
        <Suspense
          fallback={
            <p className="text-center text-gray-500">Carregando cortes...</p>
          }
        >
          <CortesLista />
        </Suspense>
