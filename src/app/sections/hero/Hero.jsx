...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative w-full h-full sm:h-screen">
      ...
      <div className="relative flex items-end sm:items-center pt-64 sm:pt-0 justify-center md:justify-start h-full text-white p-2 pb-16 sm:p-10 md:p-18">
        <header className="flex flex-col gap-6 md:gap-12 justify-center items-center md:items-start text-center md:text-left w-full max-w-4xl">
          <div className="flex flex-col justify-center items-center md:items-start pt-16 sm:pt-0 lg:max-w-xl md:justify-start gap-8 md:gap-16 mb-2">
